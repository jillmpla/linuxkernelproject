<b>A loadable Linux Kernel Module (LKM) that creates a "pseudo"-file in /proc and provides read  and write functionality for a message on the current development state of a running kernel.</b>
